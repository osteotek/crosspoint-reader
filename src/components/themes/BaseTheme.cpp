...
void drawBatteryIcon(GfxRenderer& renderer, int x, int y, int battWidth, int rectHeight, uint16_t percentage) {
  // Top line
...
void BaseTheme::drawBatteryLeft(GfxRenderer& renderer, Rect rect, const bool showPercentage) const {
...
void BaseTheme::drawBatteryRight(GfxRenderer& renderer, Rect rect, const bool showPercentage) const {
...
void BaseTheme::drawProgressBar(GfxRenderer& renderer, Rect rect, const size_t current,
...
void BaseTheme::drawSideButtonHints(GfxRenderer& renderer, const char* topBtn, const char* bottomBtn) const {
...
void BaseTheme::drawList(GfxRenderer& renderer, Rect rect, int itemCount, int selectedIndex,
...
void BaseTheme::drawHeader(GfxRenderer& renderer, Rect rect, const char* title) const {
  ...
  if (title) {
    ...
    auto truncatedTitle = renderer.truncatedText(UI_12_FONT_ID, title,
                                                 ...
                                                 CrossPointFont::BOLD);
    renderer.drawCenteredText(UI_12_FONT_ID, rect.y + 5, truncatedTitle.c_str(), true, CrossPointFont::BOLD);
  }
}

void BaseTheme::drawTabBar(GfxRenderer& renderer, const Rect rect, const std::vector<TabInfo>& tabs,
                           bool selected) const {
...
Rect BaseTheme::drawPopup(GfxRenderer& renderer, const char* message) const {
  ...
  renderer.drawText(UI_12_FONT_ID, textX, textY, message, true, CrossPointFont::BOLD);
...
void BaseTheme::drawReadingProgressBar(GfxRenderer& renderer, const size_t bookProgress) const {
