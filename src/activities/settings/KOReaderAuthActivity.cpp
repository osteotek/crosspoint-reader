...
void KOReaderAuthActivity::render(Activity::RenderLock&&) {
  ...
  renderer.drawCenteredText(UI_12_FONT_ID, 15, tr(STR_KOREADER_AUTH), true, CrossPointFont::BOLD);
  ...
  if (state == SUCCESS) {
    renderer.drawCenteredText(UI_10_FONT_ID, 280, tr(STR_AUTH_SUCCESS), true, CrossPointFont::BOLD);
  ...
  if (state == FAILED) {
    renderer.drawCenteredText(UI_10_FONT_ID, 280, tr(STR_AUTH_FAILED), true, CrossPointFont::BOLD);
