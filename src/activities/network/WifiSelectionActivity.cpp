...
void WifiSelectionActivity::renderNetworkList() const {
  ...
  // Draw header
  renderer.drawCenteredText(UI_12_FONT_ID, 15, tr(STR_WIFI_NETWORKS), true, CrossPointFont::BOLD);
...
void WifiSelectionActivity::renderConnecting() const {
  ...
  if (state == WifiSelectionState::SCANNING) {
    ...
    renderer.drawCenteredText(UI_12_FONT_ID, top - 40, tr(STR_CONNECTING), true, CrossPointFont::BOLD);
...
void WifiSelectionActivity::renderConnected() const {
  ...
  renderer.drawCenteredText(UI_12_FONT_ID, top - 30, tr(STR_CONNECTED), true, CrossPointFont::BOLD);
...
void WifiSelectionActivity::renderSavePrompt() const {
  ...
  renderer.drawCenteredText(UI_12_FONT_ID, top - 40, tr(STR_CONNECTED), true, CrossPointFont::BOLD);
...
void WifiSelectionActivity::renderConnectionFailed() const {
  ...
  renderer.drawCenteredText(UI_12_FONT_ID, top - 20, tr(STR_CONNECTION_FAILED), true, CrossPointFont::BOLD);
...
void WifiSelectionActivity::renderForgetPrompt() const {
  ...
  renderer.drawCenteredText(UI_12_FONT_ID, top - 40, tr(STR_FORGET_NETWORK), true, CrossPointFont::BOLD);
