...
void ChapterHtmlSlimParser::flushPartWordBuffer() {
  ...
  if (isBold) {
    fontStyle = static_cast<CrossPointFont::Style>(fontStyle | CrossPointFont::BOLD);
  }
  if (isItalic) {
    fontStyle = static_cast<CrossPointFont::Style>(fontStyle | CrossPointFont::ITALIC);
  }
  if (isUnderline) {
    fontStyle = static_cast<CrossPointFont::Style>(fontStyle | CrossPointFont::UNDERLINE);
  }
